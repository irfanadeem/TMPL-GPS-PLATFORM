...
Route::group(['middleware' => [], 'namespace' => 'Api'], function () {
    ...
    Route::group(['middleware' => ['auth.api', 'active_subscription']], function () {
        ...
        Route::any('get_services', ['as' => 'api.get_services', 'uses' => 'ServicesController@index']);
        Route::any('add_service_data', ['as' => 'api.add_service_data', 'uses' => 'ServicesController@create']);
        Route::any('add_service', ['as' => 'api.add_service', 'uses' => 'ServicesController@store']);
        Route::any('edit_service_data', ['as' => 'api.edit_service_data', 'uses' => 'ServicesController@edit']);
        Route::any('edit_service', ['as' => 'api.edit_service', 'uses' => 'ServicesController@update']);
        Route::any('destroy_service', ['as' => 'api.destroy_service', 'uses' => 'ServicesController@destroy']);
        ...
        Route::any('get_history_filtered', ['as' => 'api.get_history_filtered', 'uses' => 'ApiController@HistoryController#getFiltered']);
        ...
        Route::any('get_fuel_reports', ['as' => 'api.get_fuel_reports', 'uses' => 'FuelReportController@index']);
        Route::get('temperature/history', 'TemperatureController@history');
        Route::get('temperature/fleet-summary', 'TemperatureController@fleetSummary');
        Route::get('temperature/latest', 'TemperatureController@latest');
        Route::get('trip_reports', 'TripReportController@index');

        # Services
        Route::get('services', 'ServicesController@index');
        Route::get('services/create_data', 'ServicesController@create');
        Route::post('services', 'ServicesController@store');
        Route::get('services/{id}/edit_data', 'ServicesController@edit');
