                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" role="menu" aria-labelledby="dropTools">
                            ...
                            <li>
                                <a href="javascript:" onclick="app.geofences.list();app.openTab('geofencing_tab');">
                            ...
                            <li>
                                <a href="javascript:" onclick="app.routes.list();app.openTab('routes_tab');">
                            ...
                            <li>
                                <a href="javascript:" onClick="app.pois.list();app.openTab('pois_tab');">
                            ...
                            <li>
                                <a href="javascript:" data-url="{{ route('forwards.index') }}" data-modal="forwards">
                                    ...
                                    <span class="text">{!! trans('front.forwards') !!}</span>
                                </a>
                            </li>
                            @endif
                        </ul>
