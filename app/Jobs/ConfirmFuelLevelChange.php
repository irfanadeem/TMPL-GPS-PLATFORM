...
class ConfirmFuelLevelChange extends AbstractConfirmFuelLevel
{
    ...
    public function __construct(
        ...
        $this->maxIdleDuration = settings('main_settings.default_object_online_timeout') * 30;
...
//        }
    ...
    {
        if ($this->device->min_fuel_fillings != 3)
