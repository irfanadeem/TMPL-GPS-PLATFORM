...
class Kernel extends ConsoleKernel {
    ...
    protected $commands = [
        ...
        'App\Console\Commands\CheckAlertsCommandTest',
        ...
        'App\Console\Commands\ReportDashboardCommand',
        'App\Console\Commands\ReportDashboardHourlyCommand'
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command("command:ReportDashBord")->hourlyAt(0);
