...
<!-- <div class="container" style="border: 2px solid #ccc; border-radius: 5px; padding: 1px; margin: 1px auto; max-width: 100%;">-->
    ...
    <div class="row d-flex align-items-center gap-3">
        ...
        <div class="col-xs-12 col-sm-4" style="float: left;">
            ...
            <button type="submit" class="btn btn-primary w-100 mt-4" style="margin-top: 27px;">Submit</button>
            <span><a href="https://103.83.91.81/mastertable.html#" class="btn btn-primary w-100 mt-4" style="margin-top: 27px;" role="button">Analytics</a></span>


        <!-- Submit Button -->
        <div class="col-md-2 col-xs-2" style="float: right;margin-top: 26px;width:18%">
            <button class="btn btn-success w-100 mt-4">Download</button>
            <button class="btn btn-success w-100 mt-4">Print</button>
            <button  id="btn-print" class="btn btn-success w-100 mt-4">Email</button>
        </div>
    </div>
</div>
    ...
    <div class="container" style="border: 2px solid #ccc; border-radius: 5px; padding: 10px; margin: 10px auto; max-width: 100%;">            
        <div class="col-sm-6">
            ...
            <div class="panel-body" style="height: 300px; width: 100%; overflow-y: auto;">
        ...
        <!-- Engine Stats Block -->  
        <div class="container" style="border: 2px solid #ccc; border-radius: 5px; padding: 10px; margin: 10px auto; max-width: 100%; text-align: center;">
    <div class="row justify-content-center" style="margin-left:28%">
