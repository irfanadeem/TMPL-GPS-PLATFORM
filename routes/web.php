...
Route::group([], function () {
    ...
    Route::group(['middleware' => ['auth', 'auth.admin'], 'prefix' => 'admin/chatbot', 'namespace' => 'Admin'], function() {
        Route::get('/', ['as' => 'admin.chatbot.index', 'uses' => 'ChatbotAdminController@index']);
        Route::get('/logs', ['as' => 'admin.chatbot.logs', 'uses' => 'ChatbotAdminController@logs']);
        Route::get('/quotas', ['as' => 'admin.chatbot.quotas', 'uses' => 'ChatbotAdminController@quotas']);
        Route::post('/quotas/create', ['as' => 'admin.chatbot.quotas.create', 'uses' => 'ChatbotAdminController@createQuota']);
        Route::post('/quotas/{user}', ['as' => 'admin.chatbot.quotas.update', 'uses' => 'ChatbotAdminController@updateQuota']);
    });
});
...
Route::group(['middleware' => ['auth', 'active_subscription'], 'namespace' => 'Frontend'], function () {
    ...
    Route::get('devices_refill/{filter?}', ['as' => 'events.devices_refill', 'uses' => 'EventsController@refill']);
    Route::get('fuelTheft/{filter?}', ['as' => 'events.fuelTheft', 'uses' => 'EventsController@fuelTheft']);
    Route::get('fuel_consumption/{filter?}', ['as' => 'events.fuel_consumption', 'uses' => 'EventsController@fuelConsumption']);
    Route::get('fuel_summary/{filter?}', ['as' => 'events.fuel_summary', 'uses' => 'EventsController@fuelSummary']);
    Route::get('current_fuel/{filter?}', ['as' => 'events.current_fuel', 'uses' => 'EventsController@currentFuel']);
    Route::get('events_filter/{filter?}', ['as' => 'events.events_filter', 'uses' => 'EventsController@searchEvent']);
    ...
    Route::any('events/customTable', ['as' => 'events.customTable', 'uses' => 'EventsController@eventsTable']);
    ...
    Route::post('dashboard/config_update_all_block', ['as' => 'dashboard.config_update_all_block', 'uses' => 'DashboardController@updateConfigAllBlock']);
    
    # Enhanced Dashboard Data
    Route::get('dashboard/enhanced_data', ['as' => 'dashboard.enhanced_data', 'uses' => 'DashboardController@getEnhancedDashboardData']);
    Route::post('dashboard/clear_cache', ['as' => 'dashboard.clear_cache', 'uses' => 'DashboardController@clearDashboardCache']);
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'auth.manager', 'active_subscription'], 'namespace' => 'Admin'], function () {
    ...
    Route::group(['as' => 'admin.'], function() {
        ...
        #Master table 
        Route::any('master_table/index', ['as' => 'mastertable.index', 'uses' => 'MasterTableController@index']);
        Route::any('master_table/data', ['as' => 'mastertable.data', 'uses' => 'MasterTableController@fetchData']);
        Route::any('master_table/view', ['as' => 'mastertable.view', 'uses' => 'MasterTableController@masterTableView']);
        Route::any('master_table/download', ['as' => 'mastertable.download', 'uses' => 'MasterTableController@downloadData']);
        Route::any('master_table/print', ['as' => 'mastertable.print', 'uses' => 'MasterTableController@printData']);
        Route::any('travelled/view/{data?}', ['as' => 'travelled.view', 'uses' => 'MasterTableController@travelledView']);
