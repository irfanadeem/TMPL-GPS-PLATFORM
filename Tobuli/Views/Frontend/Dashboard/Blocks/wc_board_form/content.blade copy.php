...
">
        ...
        <div class="col-md-12">
                    ...
                    <div class="col-md-2" style="float: left;">
                        ...
                        <input type="date" class="form-control"
                               ...
                               value="{{$options['from_date']??Carbon::now()->format('Y-m-d')}}">
                    </div>
                    ...
                    <div class="col-md-2" style="float: left;">
                        ...
                        <input type="date" class="form-control"
                               ...
                               value="{{$options['to_date']??Carbon::now()->format('Y-m-d')}}">
                    </div>
     ...
     <!-- Engine Stats Block -->
     <div class="container" style="border-radius: 5px; padding: 5px; margin: 5px auto; max-width: 100%; background-color:rgb(69, 66, 241);margin-top: 5px;">
                    <div class="col-md-8">
